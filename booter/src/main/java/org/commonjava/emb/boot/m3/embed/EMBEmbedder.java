package org.commonjava.emb.boot.m3.embed;
...
import org.commonjava.emb.boot.m3.log.EventLogger;
import org.commonjava.emb.boot.m3.main.EMBMain;
import org.commonjava.emb.boot.m3.services.EMBServiceManager;
...
public class EMBEmbedder
{
    ...
    public MavenExecutionResult execute( final EMBExecutionRequest request )
        throws EMBEmbeddingException
    {
    ...
    protected synchronized void injectEnvironment( final EMBExecutionRequest request )
        throws EMBEmbeddingException
    {
    ...
    protected void injectSettings( final EMBExecutionRequest request )
        throws EMBEmbeddingException
    {
