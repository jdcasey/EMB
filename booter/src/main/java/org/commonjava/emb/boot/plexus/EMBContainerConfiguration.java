...
public class EMBContainerConfiguration
    implements ContainerConfiguration
{
    ...
    public EMBContainerConfiguration( final EMBConfiguration embConfig, final ComponentSelector selector,
    ...
    {
        return new ContainerInitializationPhase[] { new InitEMBRegistryPhase( embConfig, instanceRegistry ),
