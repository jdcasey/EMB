...
public class OverridableComponentManagerManager
    extends DefaultComponentManagerManager
{

    @Override
    public ComponentManager findComponentManagerByComponentKey( final String componentKey )
    {
        return super.findComponentManagerByComponentKey( OverrideManager.findOverride( componentKey ) );
    }
