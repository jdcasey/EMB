...
import org.commonjava.xaven.boot.m3.embed.XavenEmbedder;
...
public class XavenMain
{
        ...
        throws Exception
    {
        ...
        if ( cliRequest.commandLine.hasOption( CLIManager.VERSION ) )
        {
            ...
            {
                cliRequest.builder.logger().error( "Failed to retrieve Xaven extension information: " + e.getMessage(),
                                                   e );
            }
    ...
    {
        final XavenEmbedder embedder = cliRequest.builder.build();
