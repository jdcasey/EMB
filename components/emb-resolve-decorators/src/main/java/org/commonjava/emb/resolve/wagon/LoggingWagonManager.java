...
import org.commonjava.emb.resolve.event.EventStatus;
import org.commonjava.emb.resolve.util.ContextBuilder;
...
public class LoggingWagonManager
    implements WagonManager
{
        ...
        throws TransferFailedException, ResourceDoesNotExistException
    {
        ...
        try
        {
            delegate.getArtifact( artifact, repository );
        ...
        throws TransferFailedException, ResourceDoesNotExistException
    {
        ...
        try
        {
            delegate.getArtifact( artifact, remoteRepositories );
    ...
    public AuthenticationInfo getAuthenticationInfo( final String id )
    {
        ...
        final AuthenticationInfo result = delegate.getAuthenticationInfo( id );
    ...
    public ArtifactRepository getMirrorRepository( final ArtifactRepository repository )
    {
        ...
        final ArtifactRepository result = delegate.getMirrorRepository( repository );
    ...
    public ProxyInfo getProxy( final String protocol )
    {
        ...
        final ProxyInfo result = delegate.getProxy( protocol );
        ...
        throws UnsupportedProtocolException, WagonConfigurationException
    {
        ...
        final Wagon result = delegate.getWagon( repository );
        ...
        throws UnsupportedProtocolException
    {
        ...
        final Wagon result = delegate.getWagon( protocol );
    ...
    public boolean isOnline()
    {
        ...
        final boolean result = delegate.isOnline();
