 ...
 */
public class SchemeAwareArtifactVersion
    implements ArtifactVersion
{
    ...
    private VersionComparison comparable;

    private final VersionScheme scheme;

    public SchemeAwareArtifactVersion( final String version )
    {
        scheme = VersionSchemeSelector.getTLCurrentVersionScheme();
        parseVersion( version );
    }

    public SchemeAwareArtifactVersion( final String version, final String versionScheme )
    {
        scheme = VersionSchemeSelector.getTLVersionScheme( versionScheme );
        parseVersion( version );
    }

    public SchemeAwareArtifactVersion( final String version, final VersionScheme scheme )
    {
        this.scheme = scheme;
        parseVersion( version );
    }
    ...
    {
        final SchemeAwareArtifactVersion otherVersion = (SchemeAwareArtifactVersion) o;
    ...
    {
        comparable = scheme.getComparableVersion( version );
