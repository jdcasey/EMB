...
package org.commonjava.emb.mirror.search;
    ...
    implements RouterDiscoveryStrategy
{
        ...
        throws AutoMirrorException
    {
        ...
        {
            throw new AutoMirrorException( "[autonx] Failed to initialize JNDI context for DNS lookups: {0}", e,
                                           e.getMessage() );
        }
        ...
        {
            throw new AutoMirrorException( "[autonx] Failed to retrieve local hostnames: {0}", e, e.getMessage() );
        }
